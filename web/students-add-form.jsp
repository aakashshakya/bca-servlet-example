...
<html>
    ...
    <body>
        ...
        <form method="POST" action="http://localhost:8080/JAVA_SERVLET_BCA_2075/add-student-info">
            <div class="container">
                ...
                <input type="text" name="faculty" id="faculty" required="" placeholder="Enter your faculty" /><br>
